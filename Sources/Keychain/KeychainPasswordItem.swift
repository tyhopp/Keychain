/*
    Adopted from Apple's sample code:
    ...
    Edits made:
        - Moved `KeychainError` out of closure
        - Added explicit `public` access modifier to `KeychainPasswordItem`
 
    Original license:
        https://developer.apple.com/library/archive/samplecode/GenericKeychain/Listings/LICENSE_txt.html#//apple_ref/doc/uid/DTS40007797-LICENSE_txt-DontLinkElementID_8
 
    Copied license without modification in this project's repo
        https://github.com/tyhopp/Keychain/blob/main/LICENSE-KeychainPasswordItem.md
*/
